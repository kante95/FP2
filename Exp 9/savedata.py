...
np.savetxt("prova.csv", a, delimiter=",")
...
a = np.stack((input_current, power,error_power), axis=-1)
np.savetxt("diodelasecharacterization.csv", a, delimiter=",")
...
a = np.stack((input_current, power,error_power), axis=-1)
np.savetxt("littrowconfiguration.csv", a, delimiter=",")
...
a = np.stack((input_current, power,error_power), axis=-1)
np.savetxt("littmanconfiguration_withfeddback.csv", a, delimiter=",")
...
a = np.stack((input_current, power,error_power), axis=-1)
np.savetxt("littmanconfiguration_withoutfeddback.csv", a, delimiter=",")